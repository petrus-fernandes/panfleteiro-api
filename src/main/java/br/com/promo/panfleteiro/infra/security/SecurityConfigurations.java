    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity https) throws Exception {
        return https.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> authorize
                                ...
                                .requestMatchers(HttpMethod.GET, "/v1/validacoes/**").hasRole("USER")
                                .requestMatchers(HttpMethod.POST, "/v1/validacoes/**").hasRole("USER")
                                .requestMatchers(HttpMethod.DELETE, "/v1/validacoes/**").hasRole("USER")
                                .requestMatchers(HttpMethod.POST, "/v1/anuncios/lot").hasRole("USER")
                                .requestMatchers(HttpMethod.POST, "/v1/auth/register").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/v1/auth/usuarios").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.GET, "/v1/auth/usuarios").hasRole("ADMIN")
