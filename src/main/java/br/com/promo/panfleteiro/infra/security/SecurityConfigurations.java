    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity https) throws Exception {
        return https.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> authorize
                                ...
                                .requestMatchers(HttpMethod.GET, "/v1/validacoes/**").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/v1/validacoes/**").permitAll()
                                .requestMatchers(HttpMethod.POST, "/v1/anuncios/lot").permitAll()
